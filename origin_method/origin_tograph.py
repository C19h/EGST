...
from origin_method.origin_config import Config
...
def main():
    ...
    #     generate_graph(origin_path_list[i], target_path_list[i], label_list[i], split_graph_num=Config.split_graph_num)
