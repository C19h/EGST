...
model = PlGraphAttention(Config, num_attention=1, learning_rate=0.001, f_graph_dim=24, heads=1)
...
trainer = pl.Trainer(accelerator='gpu', max_epochs=200, callbacks=callback, logger=logger,
